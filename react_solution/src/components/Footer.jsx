    ...
    return (
        <footer className="footer">
            <div className="footer__flex">
                <p className="footer__text">CSS<br /> IS<br /> AWESOME<br /></p>
                <p className="footer__logo"><span>nabthat</span></p>
                <div>
                    <button className="footer__button" onClick={togglePanel}>
                        <p><b>POKAŻ</b></p>
                        {isPanelVisible ? <FontAwesomeIcon icon={faChevronDown} /> : <FontAwesomeIcon icon={faChevronUp} />}
                    </button>
                    {isPanelVisible && (
                        <div className="footer__panel">
                            <div className="footer__panel-option">
